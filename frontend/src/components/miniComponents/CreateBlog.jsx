...
const CreateBlog = () => {
  ...
  const handleBlog = async (e) => {
    ...
    formData.append("year", postYear.toString());
        ...
        <form onSubmit={handleBlog}>
          <div className="category-box">
            ...
            >
              ...
              <option value="Book Blog ">Book Blog</option>
          ...
          <div className="publish-box">
            <label>Post Year</label>
            <input type="number" value={postYear} onChange={(e) => setPostYear(e.target.value)} />
          </div>
           <button className="create-btn" type="submit" disabled={isLoading}>
            {isLoading ? "Posting..." : "POST BLOG"} {/* Change button text based on loading state */}
          </button>
        </form>
      </div>
    </section>
